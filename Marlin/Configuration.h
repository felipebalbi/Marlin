...
#define STRING_CONFIG_H_AUTHOR "(balbi; Ender-5 Pro SKR Mini E3 V3.0)" // Who made the changes.
...
#define MACHINE_UUID "ad8f2425-843a-4048-9485-92d7a34c8f73"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -46.5, -4.6, -1.1 }
